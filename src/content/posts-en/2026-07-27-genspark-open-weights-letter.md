---
title: Genspark Joins NVIDIA, Microsoft, and Others in Signing an Open-Weight AI Policy Letter
description: Genspark has co-signed the "Open Weights and American AI Leadership" letter alongside NVIDIA, Microsoft, Meta, IBM, and Palantir, arguing that its agent platform's routing across 70-plus models depends on a wide field of open models staying available.
pubDate: 2026-07-27
category: genspark
type: news
tags: [Genspark, open weights, policy]
source: https://www.genspark.ai/blog/why-genspark-supports-open-weight-ai
draft: false
importance: low
---

Genspark has announced that it co-signed the "Open Weights and American AI Leadership" letter, joining major tech companies including NVIDIA, Microsoft, Meta, IBM, and Palantir. The letter argues that open-weight models — ones users can download, inspect, modify, and run on their own infrastructure — matter for both innovation and security.
