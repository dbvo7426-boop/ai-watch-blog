---
title: Google、「Gemini 1.5」発表──コンテキスト長100万トークンで長編動画・大規模コードも一括処理
description: Googleが次世代モデル「Gemini 1.5」を発表。最大100万トークンという当時破格のコンテキストウィンドウで、長編動画やコードベース全体を一度に読み込める性能を実現した。
pubDate: 2024-02-15
category: gemini
type: news
