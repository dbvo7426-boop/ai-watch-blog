---
title: 「Claude 3.5 Sonnet」登場、最上位Opusを中位モデルの価格で上回る
description: Anthropicが発表したClaude 3.5 Sonnetは、コーディングなど多くの評価で当時の最上位モデルOpusを上回りながら、価格と速度はSonnet並みを維持。新機能「Artifacts」も同時公開されました。
pubDate: 2024-06-20
category: claude
type: news
