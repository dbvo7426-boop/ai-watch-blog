---
title: MIT出身の4人が「Cursor」公開──AIを前提に設計されたコードエディタ
description: MIT出身の4人が設立したAnysphereが、AIをネイティブに組み込んだコードエディタ「Cursor」を公開。VS Codeをベースに、GitHub Copilotより深いAI統合を目指してひっそりと開発をスタートしました。
pubDate: 2023-03-01
category: cursor
type: news
