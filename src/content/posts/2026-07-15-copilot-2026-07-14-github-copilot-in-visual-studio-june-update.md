...
Visual StudioはWindows専用の重量級IDEのため、手元のPCのスペックに不安がある場合は、[Windows VPS](https://px.a8.net/svt/ejp?a8mat=4B81T6+AINPIQ+CO4+2BHM5T)上にリモートデスクトップで環境を構築し、そこでCopilot付きのVisual Studioを動かすという選択肢もあります。
