---
title: Lindy、企業向け統制機能「Lindy Enterprise」を発表──SSO・監査ログ・SOC 2対応
description: LindyがSSOやSCIMプロビジョニング、監査ログ、SOC 2 Type II認証などを備えた企業向けプラン「Lindy Enterprise」を発表。組織全体でAIエージェントを安全に管理・統制できる体制を整えました。
pubDate: 2025-11-20
category: lindy
type: news
