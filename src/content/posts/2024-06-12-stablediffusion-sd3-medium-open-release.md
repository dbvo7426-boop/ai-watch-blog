---
title: Stable Diffusion 3 Mediumがオープンウェイトで公開──個人PCでも動く20億パラメータモデル
description: Stability AIが台北のComputexでStable Diffusion 3 Mediumの重みを一般公開。20億パラメータながら文字表現・写実性が向上し、商用・非商用を問わず無料で利用可能になりました。
pubDate: 2024-06-12
