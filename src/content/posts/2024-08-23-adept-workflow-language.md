---
title: Amazon移籍後のAdept、独自言語「AWL」でエージェント構築の再出発をアピール
description: 中核創業者らがAmazonへ移籍した後のAdeptが、新CEO Zach Brock氏体制下で独自ワークフロー言語「Adept Workflow Language(AWL)」を紹介する記事を公開。会社として存続し続けている姿勢を示しました。
pubDate: 2024-08-23
category: adept
type: news
