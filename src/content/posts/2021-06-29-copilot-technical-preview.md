---
title: GitHub Copilot、テクニカルプレビューとして登場——AIペアプログラマーの原点
description: GitHubがOpenAI Codexを活用したAIコーディング支援ツール「GitHub Copilot」のテクニカルプレビューを発表。コードの一行や関数全体を提案する、後のAIコーディングブームの出発点となりました。
pubDate: 2021-06-29
category: copilot
type: news
