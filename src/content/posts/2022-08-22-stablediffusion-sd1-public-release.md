---
title: Stable Diffusionが一般公開──オープンソースの画像生成AIが誰でも使える時代へ
description: Stability AIがStable Diffusionをオープンソースとして一般公開。CreativeML OpenRAIL-Mライセンスのもと、誰でもモデルをダウンロードして利用できるようになりました。
pubDate: 2022-08-22
