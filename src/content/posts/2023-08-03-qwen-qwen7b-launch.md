---
title: Alibaba、「Qwen-7B」をオープンソース公開──中国発LLMがMetaに挑む
description: AlibabaがLLM「Qwen-7B」とその対話版「Qwen-7B-Chat」をオープンソース公開。学術・商業利用ともに無償で使えるモデルとして中国発オープンLLMの先陣を切りました。
pubDate: 2023-08-03
category: qwen
type: news
