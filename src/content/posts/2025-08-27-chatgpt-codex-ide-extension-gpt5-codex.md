---
title: Codex、IDE拡張機能と専用モデル「GPT-5-Codex」で「統一されたエージェント体験」へ
description: OpenAIがVS Codeなどで使える「Codex IDE拡張機能」と、コーディング特化モデル「GPT-5-Codex」を発表。ターミナル・クラウド・IDE・GitHubを横断する単一のCodex体験へと統合されました。
pubDate: 2025-08-27
category: chatgpt
type: news
