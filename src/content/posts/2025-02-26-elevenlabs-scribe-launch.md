---
title: ElevenLabsが音声認識モデル「Scribe」を発表──音声合成企業が文字起こしにも参入
description: ElevenLabsが独自の音声認識(ASR)モデル「Scribe」を発表。99言語に対応し、単語単位のタイムスタンプや話者分離機能も備え、音声合成に続く新たな柱となりました。
pubDate: 2025-02-26
category: elevenlabs
type: news
