---
title: Google、「Bard」を「Gemini」に統一──Ultra 1.0搭載の有料プラン「Gemini Advanced」も開始
description: GoogleがBardブランドを廃止し「Gemini」に一本化。最上位モデルUltra 1.0を使える有料プラン「Gemini Advanced」とAndroid向けアプリを同時に開始した。
pubDate: 2024-02-08
category: gemini
type: news
