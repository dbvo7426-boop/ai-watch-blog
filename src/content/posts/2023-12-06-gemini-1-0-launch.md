---
title: Google、マルチモーダルAI「Gemini 1.0」発表──Ultra・Pro・Nanoの3サイズ展開
description: Googleが新世代AIモデル「Gemini 1.0」を発表。テキスト・画像・音声・動画・コードを統合的に扱うマルチモーダル設計で、Ultra・Pro・Nanoの3モデルを用意した。
pubDate: 2023-12-06
category: gemini
type: news
